...
describe('MatSlider', () => {
  ...
  describe('standard slider', () => {
    ...
    let sliderInstance: RangeSliderComponent;
    ...
    beforeEach(() => {
      ...
      sliderDebugElement = fixture.debugElement.query(By.directive(RangeSliderComponent));
  ...
  describe('slider with set min and max', () => {
    ...
    beforeEach(() => {
      ...
      sliderNativeElement = sliderDebugElement.nativeElement;
      sliderInstance = sliderDebugElement.injector.get<RangeSliderComponent>(RangeSliderComponent);
      trackFillElement = <HTMLElement>sliderNativeElement.querySelector('.mat-slider-track-fill');
  ...
  describe('tabindex', () => {
    ...
    it('should allow setting the tabIndex through binding', () => {
      ...
      const slider = fixture.debugElement.query(By.directive(RangeSliderComponent)).componentInstance;
